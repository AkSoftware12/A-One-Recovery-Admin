...
class BktWiseFosCountScreen extends StatefulWidget {
  @override
  _RecoveryReportScreenState createState() => _RecoveryReportScreenState();
}

class _RecoveryReportScreenState extends State<BktWiseFosCountScreen> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('${ApiRoutes.bktWiseFosCountReport}?month=$selectedMonth&year=$selectedYear'),
        headers: {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Expanded(child: _buildInfoRow(Icons.calculate, 'Total Count', grandTotal['total_count'])),
                        SizedBox(width: 10),
                        Expanded(child: _buildInfoRow(Icons.check_circle, 'Paid Count', grandTotal['paid_count'], iconColor: Colors.green.shade600)),
                      ],
                    ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Expanded(child: _buildInfoRow(Icons.cancel, 'Unpaid Count', grandTotal['unpaid_count'], iconColor: Colors.red.shade600)),
                        SizedBox(width: 10),
                        Expanded(child: _buildInfoRow(Icons.percent, 'Collection %', '${grandTotal['collection_percent'].toStringAsFixed(1)}%', iconColor: Colors.blueAccent)),
                      ],
                    ),
                    const SizedBox(height: 10),
                              ...
                              return TableRow(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Center(
                                      child: Text(data['total_count'].toString(),
                                        style: TextStyle(
                                            fontSize: 14.sp,
                                            fontWeight: FontWeight.w600// <-- Set your desired font size here
                                        ),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Center(
                                      child: Text(data['paid_count'].toString(),
                                        style: TextStyle(
                                            fontSize: 14.sp,
                                            fontWeight: FontWeight.w600// <-- Set your desired font size here
                                        ),
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Center(
                                      child: Text(data['unpaid_count'].toString(),
                                        style: TextStyle(
                                            fontSize: 14.sp,
                                            fontWeight: FontWeight.w600// <-- Set your desired font size here
                                        ),
