...
class EmployeeDeductionListScreen extends StatefulWidget {
  const EmployeeDeductionListScreen({
    super.key,
  });

  @override
  State<EmployeeDeductionListScreen> createState() =>
      _AllIndiaRankScreenState();
}

class _AllIndiaRankScreenState extends State<EmployeeDeductionListScreen> {
  ...
  Future<void> fetchDeductionList() async {
    ...
    final response = await http.get(
      Uri.parse(ApiRoutes.employeeDeductionList),
      headers: {'Authorization': 'Bearer $token'},
    );
